layui.define(['jquery', 'layer'], function (exports) {
    ...
    $(function () {
        ...
        me.layerOpen = function () {
            if (top.layui) {
                return top.layui.layer.open.apply(this, arguments);
            }
        };
        me.layerFull = function (idx) {
            if (top.layui) {
                top.layui.layer.full(idx);
            }
        };
        me.layerOpenUrl = function (title, url, width, height, endCallback, max) {
