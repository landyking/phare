...
<form class="layui-form" lay-filter="dataForm">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <select name="dataType" lay-verify="required" class="hy-select" lay-filter="dataType"
                    lay-data="{url:'admin/dict/listSelectItem?dictCode=syncType'}"></select>
        </div>
    </div>
    <hr/>
    <div class="layui-form-item" style="text-align: center;">
        <button class="layui-btn" lay-submit lay-filter="save">执行</button>
...
<script>
    layui.use(['jquery', 'hyForm', 'form', 'common'], function () {
        ...
        hyForm.render({
            loadUrl: null,
            saveUrl: 'admin/syncHistory/manualTriggerSync',
