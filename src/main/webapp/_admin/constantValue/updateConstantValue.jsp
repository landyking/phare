...
<form class="layui-form" lay-filter="dataForm">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">所属常量</label>
        <div class="layui-input-block">
            <input type="text" name="constantId" required lay-verify="required" autocomplete="off" class="layui-input">
            <!--
...
<script>
    layui.use(['jquery', 'hyForm', 'form', 'common', "hyUtil"], function () {
        ...
        var form = layui.form;
        hyForm.render({
            loadUrl: "admin/constantValue/loadConstantValue?id=" + hy.getURLParam("id"),
            saveUrl: 'admin/constantValue/updateConstantValue',
