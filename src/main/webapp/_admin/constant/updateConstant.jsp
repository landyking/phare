...
<form class="layui-form" lay-filter="dataForm">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="projectName" required lay-verify="required" autocomplete="off" class="layui-input" readonly>
...
<script>
    layui.use(['jquery', 'hyForm', 'form', 'common', "hyUtil"], function () {
        ...
        var form = layui.form;
        hyForm.render({
            loadUrl: "admin/constant/loadConstant?id=" + hy.getURLParam("id"),
            saveUrl: 'admin/constant/updateConstant',
