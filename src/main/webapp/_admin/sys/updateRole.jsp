...
<form class="layui-form" lay-filter="dataForm">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="createTime" disabled autocomplete="off" class="layui-input">
        </div>
    </div>
    <hr/>
...
<script>
    layui.use(['jquery', 'hyForm', 'form', 'common', "hyUtil"], function () {
        ...
        var form = layui.form;
        hyForm.render({
            loadUrl: "admin/role/loadRole?id=" + hy.getURLParam("id"),
            saveUrl: 'admin/role/updateRole',
