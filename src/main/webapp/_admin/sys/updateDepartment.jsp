...
<form class="layui-form" lay-filter="dataForm">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
             <textarea name="address"  autocomplete="off" class="layui-textarea"></textarea>
        </div>
    </div>
    <div class="layui-form-item">
...
<script>
    layui.use(['jquery', 'hyForm', 'form', 'common', "hyUtil"], function () {
        ...
        var form = layui.form;
        hyForm.render({
            loadUrl: "admin/department/loadDepartment?id=" + hy.getURLParam("id"),
            saveUrl: 'admin/department/updateDepartment',
