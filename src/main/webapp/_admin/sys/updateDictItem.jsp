...
<form class="layui-form" lay-filter="dataForm">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <textarea name="content" required lay-verify="required" autocomplete="off"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="updateTime" disabled autocomplete="off" class="layui-input">
        </div>
    </div>
    <hr/>
...
<script>
    layui.use(['jquery', 'hyForm', 'form', 'common', "hyUtil"], function () {
        ...
        var form = layui.form;
        hyForm.render({
            loadUrl: "admin/dict/loadDictItem?id=" + hy.getURLParam("id"),
            saveUrl: 'admin/dict/updateDictItem',
