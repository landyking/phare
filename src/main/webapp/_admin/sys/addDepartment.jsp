...
<form class="layui-form" lay-filter="dataForm">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" id="pdesc" autocomplete="off" class="layui-input" readonly>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <textarea name="address" autocomplete="off"
    ...
    layui.use(['jquery', 'hyForm', 'form', 'common', 'hyUtil'], function () {
        ...
        hyForm.render({
            ...
            afterLoad: function (layFilter) {
                //custom init code
                var pid = hy.getURLParam("pid");
                var pname = decodeURI(hy.getURLParam("pname"));
                $("#pdesc").val(pname + "（编号：" + pid + "）");
